...
出自<https://www.nature.com/articles/nature18606>
...
p2<-ggplot(m5,aes(type,id,size=`-logP`))+
  ...
  scale_y_discrete(labels=mergefpkm$gene[order(mergefpkm$id)])
...
ggplot(pm5,aes(type,id,size=`-logP`))+
  ...
  scale_y_discrete(labels=pmergefpkm$gene[order(pmergefpkm$id)])
